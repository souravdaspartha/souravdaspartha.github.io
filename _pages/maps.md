...
<p style="font-size: 13px; color: #777;">
Routes digitised in Google Earth; corridor network drawn and analysed in ArcGIS Pro, animation frames exported via arcpy and assembled in Python.
</p>
